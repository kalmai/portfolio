...
![cad model for 140mm fan server cover](/server-top-cover-fusion-360.png)
...
![pile of 3d printed prototypes](/prototype-pile.jpg)
...
![lemming gif with physical server overlay](/lemming-server.gif)
...
Tragically the [Columbus Crew's](https://www.columbuscrew.com/) next game was away meaning that the location requirement was not fulfilled and my dirty car dirty much to my wife's dismay.

## Technologies Used

{{< badge text="kamal" icon="kamal" >}}
{{< badge text="rails" icon="rails" >}}
{{< badge text="ubuntu" icon="ubuntu" >}}
